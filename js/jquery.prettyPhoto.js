...
(function($) {
	...
	$.fn.prettyPhoto = function(settings) {
		settings = jQuery.extend({
							...
							<div class="pp_right"> \
								<div class="pp_content"> \
									...
									<div class="pp_fade"> \
										...
										<div class="pp_details clear_fix"> \
			...
			inline_markup: '<div class="pp_inline clear_fix">{content}</div>'
		}, settings);
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(images[setPosition])){
					...
					case 'inline':
						...
						myClone = $(images[setPosition]).clone().css({'width':settings.default_width}).wrapInner('<div id="pp_full_res"><div class="pp_inline clear_fix"></div></div>').appendTo($('body'));
